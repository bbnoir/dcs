...
//---------------------------------------------------------------------
    ...
    always_comb begin : comb
        ...
        (sorted_n3[3:0] > 4'd8) ||
        (sorted_n4[3:0] > 4'd8) ||
        (sorted_n0[5:4] == HONOR && sorted_n0[3:0] > 4'd6) ||
        (sorted_n1[5:4] == HONOR && sorted_n1[3:0] > 4'd6) ||
        (sorted_n2[5:4] == HONOR && sorted_n2[3:0] > 4'd6) ||
        (sorted_n3[5:4] == HONOR && sorted_n3[3:0] > 4'd6) ||
        (sorted_n4[5:4] == HONOR && sorted_n4[3:0] > 4'd6) ||
